...
const ourPath = "github.com/dogeum-network/go-dogeum" // Path to our module
...
// conventions in the Dogeum p2p network.
...
//
// If the package that is currently executing is a prefixed by our go-dogeum
