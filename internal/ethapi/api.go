...
import (
	...
	"github.com/dogeum-network/go-dogeum/accounts/abi"
	"github.com/dogeum-network/go-dogeum/accounts/keystore"
	"github.com/dogeum-network/go-dogeum/accounts/scwallet"
	...
	"github.com/dogeum-network/go-dogeum/eth/tracers/logger"
...
func (s *DogeumAPI) FeeHistory(ctx context.Context, blockCount math.HexOrDecimal64, lastBlock rpc.BlockNumber, rewardPercentiles []float64) (*feeHistoryResult, error) {
...
//
// https://github.com/dogeum-network/go-dogeum/wiki/Management-APIs#personal_sign
...
//
// https://github.com/dogeum-network/go-dogeum/wiki/Management-APIs#personal_ecRecover
...
// See: https://github.com/dogeum-network/wiki/wiki/JSON-RPC-Error-Codes-Improvement-Proposal
...
//
// https://github.com/dogeum-network/wiki/wiki/JSON-RPC#eth_sign
