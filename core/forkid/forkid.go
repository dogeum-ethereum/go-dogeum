...
// timestampThreshold is the Dogeum mainnet genesis timestamp. It is used to
...
// NewID calculates the Dogeum fork ID from the chain config, genesis hash, head and time.
