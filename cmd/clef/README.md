...
The signer will generate a new private key, encrypt it according to [web3 keystore spec](https://github.com/dogeum-network/wiki/wiki/Web3-Secret-Storage-Definition) and store it in the keystore directory.  
...
| Clef UI| https://github.com/dogeum-network/clef-ui| Golang/QT-based| :+1:| :+1:| :x:| :+1:| :+1:| :x: |  :+1: (approve tx only)|
