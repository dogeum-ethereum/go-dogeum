...
import (
	...
	"github.com/dogeum-network/go-dogeum/crypto/signify"
	"github.com/dogeum-network/go-dogeum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/dogeum-network/go-dogeum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/dogeum-network/go-dogeum/internal/version.gitDate="+env.Date)
	}
...
func doDocker(cmdline []string) {
	...
	//  - dogeum/client-go:latest                            - Pushes to the master branch, Geth only
	//  - dogeum/client-go:stable                            - Version tag publish on GitHub, Geth only
	//  - dogeum/client-go:alltools-latest                   - Pushes to the master branch, Geth & tools
	//  - dogeum/client-go:alltools-stable                   - Version tag publish on GitHub, Geth & tools
	//  - dogeum/client-go:release-<major>.<minor>           - Version tag publish on GitHub, Geth only
	//  - dogeum/client-go:alltools-release-<major>.<minor>  - Version tag publish on GitHub, Geth & tools
	//  - dogeum/client-go:v<major>.<minor>.<patch>          - Version tag publish on GitHub, Geth only
	//  - dogeum/client-go:alltools-v<major>.<minor>.<patch> - Version tag publish on GitHub, Geth & tools
	var tags []string
