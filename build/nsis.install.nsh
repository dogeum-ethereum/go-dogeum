...
!define HELPURL "https://github.com/dogeum-network/go-dogeum/issues"
!define UPDATEURL "https://github.com/dogeum-network/go-dogeum/releases"
!define ABOUTURL "https://github.com/dogeum-network/go-dogeum#dogeum-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Dogeum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Dogeum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Dogeum" "" 30303 "" ""
